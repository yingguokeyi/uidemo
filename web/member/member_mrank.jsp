        ...
        layui.use(['table','layer'], function(){
            ...
            table.render({
                ...
                ,cols: [[
                    ...
                    ,{field:'wealth', width:300, title: '操作',toolbar: '#barDemo'}
                ]]
            ...
            table2.render({
                ...
                ,cols: [[
                    ...
                    ,{field:'city', width:100, title: '手机号'}
                    ,{field:'sign', title: '邀请码', minWidth: 150}
                    ,{field:'experience', width:100, title: '上级人员',templet: '#usernameTpl'}
                    ,{field:'score', width:100, title: '下级人数' }
                    ,{field:'classify', width:100, title: '注册时间'}
                    ,{field:'wealth', width:100, title: '状态'}
                    ,{field:'za', width:300, title: '操作',toolbar: '#barDemo'}
                ]]
                ,page: true
            });
            table2.on('tool(demo)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
        ...
        <div class="main-top" style="margin-top:10px;">
            <table class="layui-table" lay-filter="test" style="width:610px;">
                ...
                <tr>
                    ...
                    <td>非会员</td>
                    <td>109</td>
                    <td><a href="javascript:void(0)" style="color:blue" data-method="offset" id="layerDemo" onclick="aClick()" >查看</a></td>
                </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="">
            <form class="layui-form" action="">
                ...
                <script type="text/html" id="barDemo">
                    ...
                    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del">查看上级</a>
                    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del">查看下级</a>
                </script>
            </form>
        </div>
    </div>
