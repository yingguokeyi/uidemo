...
<%@include file="menu_finance.jsp"%>
  ...
  <script type="text/html" id="barDemo">
    <a class="layui-btn layui-btn-primary layui-btn-normal" lay-event="agree" >修改</a>
      ...
      layui.use('table', function(){
          ...
          function agree(obj){
              layer.open({
                  ...
                  '                        <input name="title" placeholder='+obj.applyWithdrawalsCost+' class="layui-input" type="text" style="width:90% ;border-color: #0C0C0C">' +
                  '                    </div></li>'
                  +'<li class="layui-nav-item"><label class="layui-form-label">账户</label>' +
                  '                                     <div class="layui-input-block">' +
                  '                                         <input name="title" placeholder='+obj.playMode+' class="layui-input" type="text" style="width:90% ;border-color: #0C0C0C">' +
                  '                                     </div></li>'
                  +'<li class="layui-nav-item"><label class="layui-form-label">开户行</label>' +
                  '                                      <div class="layui-input-block">' +
                  '                                       <input name="title" placeholder='+obj.withdrawalsOddNum+' class="layui-input" type="text" style="width:90% ;border-color: #0C0C0C">' +
                  '                                    </div></li>'
